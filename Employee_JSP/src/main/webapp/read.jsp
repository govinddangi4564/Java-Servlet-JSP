		...
		<table class="table">
			...
			<tbody>
				...
				<tr>
					...
					<th><a class="btn btn-warning" href="update?id=<%=e.getId() %>">Update</a> <a
						class="btn btn-danger" href="delete?id=<%=e.getId()%>" onclick="return confirm('Are you sure you want to delete the data : <%=e.getId()%> ')">Delete</a></th>
				</tr>
